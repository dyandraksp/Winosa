<template>
    ...
    color: #000000;">Magang Full-Stack Developer
    (PHP-Java)</h1>
    </div>
    <div class="content">
    ...
    color: #000000;">
     ...
     Kami sedang memperluas dan mencari pengembang Java dan/atau PHP yang ambisius. Anda akan bekerja dari kantor kami untuk pelanggan internasional.
     <br><br>
